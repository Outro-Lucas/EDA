...
/**
 * Class Edge: Classe auxiliar que pode ser usada 
 * para implementar grafos como lista de adjacencia.
 * 
 * Essa classe eh também utilizada como tipo de retorno
 * das listas retornadas pelas funcoes abaixo da classe Graph:
 * 
...
public:
    ...
    void setEnpoint(int v) { vertex = v; }
...
public:
    ...
    // Descomente esta linha quando for fazer a questao 2
    // A funcao abaixo deve ser implementada em cada classe filha de Graph
    virtual Graph* transposto() = 0;
    
    //terceira questao
    virtual Graph* quadrado() = 0;
};
